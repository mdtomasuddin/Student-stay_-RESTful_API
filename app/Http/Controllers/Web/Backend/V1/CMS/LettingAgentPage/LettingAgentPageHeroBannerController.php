...
class LettingAgentPageHeroBannerController extends Controller
{
    ...
    public function index()
    {
        $data = CMS::firstOrCreate(
            ['page' => 'lettingAgentPage', 'section' => 'hero'],
            ['title' => null, 'image' => null, 'sub_title' => null]
        );
        return view('backend.layouts.cms.lettingAgentPage.hero', compact('data'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            $data = CMS::where('page', 'lettingAgentPage')->where('section', 'hero')->firstOrFail();
            if ($request->hasFile('image')) {
                ...
                $newImagePath = Helper::fileUpload($request->file('image'), 'lettingAgentPage/HeroBannerImages');
