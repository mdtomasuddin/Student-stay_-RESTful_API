...
class HeroBannerController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.layouts.cms.homePage.hero', compact('data'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            $data = CMS::where('page', 'homePage')->where('section', 'hero')->firstOrFail();
            if ($request->hasFile('image')) {
                ...
                $newImagePath = Helper::fileUpload($request->file('image'), 'HomePage/HeroBannerImages');
