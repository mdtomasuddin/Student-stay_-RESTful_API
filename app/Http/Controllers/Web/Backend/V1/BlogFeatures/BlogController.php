...
class BlogController extends Controller
{
            ...
            return DataTables::of($data)
                ...
                ->addColumn('action', function ($data) {
                    return '<div class="d-flex gap-2 justify-content-center">
                        <a href="' . route('blogs.show', $data->id) . '" class="btn btn-sm btn-outline-primary" title="View">
                            <i class="bi bi-eye"></i>
                        </a>
                        <a href="' . route('blogs.edit', $data->id) . '" class="btn btn-sm btn-outline-info btn-info-soft" title="Edit">
    ...
    public function store(Request $request)
    {
        $validatedData = $request->validate([
            ...
            'thumbnail'   => 'required|file|mimes:jpeg,png,jpg,gif,svg,webp,bmp,tiff,ico,avif,webm|max:204800',
    ...
    public function update(Request $request, string $id)
    {
        $validatedData = $request->validate([
            ...
            'thumbnail'   => 'sometimes|file|mimes:jpeg,png,jpg,gif,svg,webp,bmp,tiff,ico,avif,webm|max:204800',
