                ...
                return DataTables::of($data)
                    ...
                    ->addColumn('action', function ($data) {
                        ...
                        <div class="hstack gap-3 fs-base">
                            <a href="' . route('video.edit', ['video' => $data->id]) . '" class="link-primary text-decoration-none" title="Edit">
                                <i class="ri-pencil-line" style="font-size: 24px;"></i>
                            </a>
                            <a href="javascript:void(0);" onclick="showVideoDetails(' . $data->id . ')" class="link-primary text-decoration-none" data-bs-toggle="modal" data-bs-target="#viewVideoModal" title="View">
