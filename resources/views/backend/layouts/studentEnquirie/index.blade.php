...
@push('scripts')
    <script>
        ...
        async function showEnquiryDetails(id) {
            let url = '{{ route('student-enquiry.show', ':id') }}'.replace(':id', id);
                ...
                if (response.data.success) {
                    ...
                    modalBody.innerHTML = `
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <label class="fw-bold mb-1">IP Address</label>
                                <p class="mb-3 text-dark font-medium">${data.ip_address || 'N/A'}</p>
                            </div>
                            <div class="col-12">
        ...
        function deleteItem(id) {
            let url = '{{ route('student-enquiry.destroy', ':id') }}'.replace(':id', id);
            $.ajax({
                type: "DELETE",
                url: url,
                data: {
