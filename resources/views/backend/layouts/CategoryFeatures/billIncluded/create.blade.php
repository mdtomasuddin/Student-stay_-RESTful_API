...
@section('title')
    {{ env('APP_NAME') }} || Create Bills Included Topics
@endsection
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div id="createId" class="mb-4">
                                    <h2 class="h3 mb-1">Create Bills Included Topics</h2>
                                    <p>Create the Bills Included Topics details below and submit.</p>
                                </div>

                                <div class="card mb-10">
                                    <div class="tab-content p-4">
                                        <form action="{{ route('bill-includeds.store') }}" method="POST"
