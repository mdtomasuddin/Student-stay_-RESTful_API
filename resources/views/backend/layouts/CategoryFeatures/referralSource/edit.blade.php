...
@section('title')
    {{ env('APP_NAME') }} || Edit Referral sources
@endsection
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div id="editId" class="mb-4">
                                    <h2 class="h3 mb-1">Edit Referral sources</h2>
                                    <p>Update the Referral sources details below and submit.</p>
                                </div>

                                <div class="card mb-10">
                                    <div class="tab-content p-4">
                                        <form action="{{ route('referral-sources.update', $data->id) }}" method="POST"
                                            ...
                                            <div class="form-group mb-4">
                                                ...
                                                <input type="text"
                                                    ...
                                                    placeholder="Referral sources" required>
                                                @error('name')
