...
@section('title')
    {{ env('APP_NAME') }} || Edit Place Of Study
@endsection
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div id="editId" class="mb-4">
                                    <h2 class="h3 mb-1">Edit Place Of Study</h2>
                                    <p>Update the Place Of Study details below and submit.</p>
                                </div>

                                <div class="card mb-10">
                                    <div class="tab-content p-4">
                                        <form action="{{ route('place-of-studies.update', $data->id) }}" method="POST"
                                            ...
                                            <div class="form-group mb-4">
                                                ...
                                                <input type="text"
                                                    ...
                                                    placeholder="Place Of Study" required>
                                                @error('name')
