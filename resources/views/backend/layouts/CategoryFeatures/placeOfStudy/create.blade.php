...
@section('title')
    {{ env('APP_NAME') }} || Create Place Of Study
@endsection
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div id="createId" class="mb-4">
                                    <h2 class="h3 mb-1">Create Place Of Study</h2>
                                    <p>Create the Place Of Study details below and submit.</p>
                                </div>

                                <div class="card mb-10">
                                    <div class="tab-content p-4">
                                        <form action="{{ route('place-of-studies.store') }}" method="POST"
                                            ...
                                            <div class="form-group mb-4">
                                                <label class="label text-secondary"> Place Of Study</label>
                                                <input type="text"
                                                    class="form-control text-dark ps-3 h-55 @error('name') is-invalid @enderror"
                                                    name="name" value="{{ old('name') }}" placeholder="Place Of Study"
                                                    required>
                                                @error('name')
