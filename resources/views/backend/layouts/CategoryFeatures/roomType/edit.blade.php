...
@section('title')
    {{ env('APP_NAME') }} || Edit Types of Rooms
@endsection
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div id="editId" class="mb-4">
                                    <h2 class="h3 mb-1">Edit Types of Rooms</h2>
                                    <p>Update the Types of Rooms details below and submit.</p>
                                </div>

                                <div class="card mb-10">
                                    <div class="tab-content p-4">
                                        <form action="{{ route('room-types.update', $data->id) }}" method="POST"
                                            ...
                                            <div class="form-group mb-4">
                                                <label class="label text-secondary"> Types of Rooms</label>
                                                <input type="text"
                                                    class="form-control text-dark ps-3 h-55 @error('name') is-invalid @enderror"
                                                    name="name" value="{{ old('name', $data->name) }}"
                                                    placeholder="Type of room" required>
                                                @error('name')
