...
@section('title')
    {{ env('APP_NAME') }} || Create Types of Rooms
@endsection
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div id="createId" class="mb-4">
                                    <h2 class="h3 mb-1">Create Types of Rooms</h2>
                                    <p>Create the Types of Rooms details below and submit.</p>
                                </div>
                                        ...
                                        <form action="{{ route('room-types.store') }}" method="POST"
                                            ...
                                            <div class="form-group mb-4">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="name" value="{{ old('name') }}" placeholder="Type of room"
                                                    required>
                                                @error('name')
