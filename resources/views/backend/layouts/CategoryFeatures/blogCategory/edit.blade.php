...
@section('title')
    {{ env('APP_NAME') }} || Edit Blog Categories
@endsection
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div id="editId" class="mb-4">
                                    <h2 class="h3 mb-1">Edit Blog Categories</h2>
                                    <p>Update the Blog Categories details below and submit.</p>
                                </div>

                                <div class="card mb-10">
                                    <div class="tab-content p-4">
                                        <form action="{{ route('blog-categories.update', $data->id) }}" method="POST"
