...
@section('title', 'Letting Agent Page Hero Banner')

@section('content')
    <div class="main-content-container">
        {{-- Header Section --}}
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4">
            <h3 class="mb-0">Letting Agent Page Hero Banner </h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb align-items-center mb-0">
                    <li class="breadcrumb-item"><a href="#" class="text-decoration-none">Dashboard</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Letting Agent Page Hero Banner</li>
                </ol>
            </nav>
        </div>
                    ...
                    <div class="col-lg-11">
                        ...
                        <div class="card shadow-sm border-0">
                            <div class="card-header bg-white py-3">
                                <h5 class="mb-0">Letting Agent Page Hero Banner</h5>
                            </div>
                            <div class="card-body p-4">
                                <form action="{{ route('letting-agent-hero.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
