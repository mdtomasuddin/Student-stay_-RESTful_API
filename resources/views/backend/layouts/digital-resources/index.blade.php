                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('digital-resources.index') }}">Table</a></li>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5 class="card-title mb-0">All Digital Resources</h5>
                            <a href="{{ route('digital-resources.create') }}" class="btn btn-primary btn-sm">Add Digital
                                Resource</a>
                        </div>
                        <div class="card-body">
    ...
    <script>
        $(document).ready(function() {
            var dTable = $('#datatable').DataTable({
                ...
                serverSide: true,
                responsive: true,
                ajax: "{{ route('digital-resources.index') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
        ...
        function changeStatus(event, id) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.post(`/digital-resources/status/${id}`, {
                            _token: '{{ csrf_token() }}'
                        })
                        .done(res => {
