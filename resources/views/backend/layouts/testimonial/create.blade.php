            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xl-9 col-md-12 col-sm-12 col-12">
                        <div class="row">
                            <div class="col-12">
                                <div id="edit-Testimonial" class="mb-4">
                                    <h2 class="h3 mb-1">Create Testimonial</h2>
                                    <p>Create the Testimonial details below and submit.</p>
                                </div>
                                        ...
                                        <form action="{{ route('testimonials.store') }}" method="POST"
                                            ...
                                            <div class="form-group mb-4">
                                                ...
                                                <input type="text"
                                                    ...
                                                    placeholder="Enter Testimonial name here" required>
                                                @error('name')
                                            ...
                                            <div class="form-group mb-4">
                                                ...
                                                <textarea class="form-control text-dark ps-3 h-100 @error('message') is-invalid @enderror" name="message" rows="4"
                                                    placeholder="Enter message here">{{ old('message') }}</textarea>
                                                @error('message')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
