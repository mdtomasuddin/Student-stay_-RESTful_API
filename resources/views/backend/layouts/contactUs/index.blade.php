...
@push('scripts')
    <script>
        ...
        async function showEnquiryDetails(id) {
            let url = '{{ route('contact-us.show', ':id') }}'.replace(':id', id);
                    ...
                    modalBody.innerHTML = `
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <p class="mb-3 text-dark font-medium">${data.full_name || 'N/A'}</p>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <label class="fw-bold mb-1">Place of Study</label>
                                <p class="mb-3 text-dark font-medium">${placeOfStudy}</p>
                            </div>
                            <div class="col-md-6">
                                <label class="fw-bold mb-1">Budget</label>
                                <p class="mb-3 text-dark font-medium">${data.budget || 'N/A'}</p>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <p class="mb-3 text-dark font-medium">${referralSource}</p>
                            </div>
                            <div class="col-md-6">
                                <label class="fw-bold mb-1">Status</label>
                                <p class="mb-3 text-dark font-medium"><span class="badge bg-primary text-uppercase">${data.status || 'N/A'}</span></p>
                            </div>
                            <div class="col-12">
                                <label class="fw-bold mb-1">Other Preferences</label>
                                <div class="p-3 bg-light rounded border text-dark" style="white-space: pre-wrap;">${data.other_preferences || 'No other preferences provided.'}</div>
                            </div>
                        </div>
                    `;
                } else {
        ...
        function deleteItem(id) {
            let url = '{{ route('contact-us.destroy', ':id') }}'.replace(':id', id);
            $.ajax({
                type: "DELETE",
                url: url,
                data: {
