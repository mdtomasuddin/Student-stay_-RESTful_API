                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('faq.create') }}" class="btn btn-primary btn-sm" id="addNewPage">Add FAQ <i
                                ...
                                <table id="datatable"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center column-content">Question</th>
                                            <th class="text-center column-content">Answer</th>
                                            <th class="text-center column-status" style="width: 8%">Status</th>
                                            <th class="text-center column-action" style="width: 15%">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        {{-- Dynamic Data --}}
        ...
        async function showFAQDetails(id) {
            ...
            try {
                ...
                if (response.data && response.data.data) {
                    ...
                    let serviceName = data.lead_service ? data.lead_service.name :
                    ...
                    modalBody.innerHTML = `
                            ...
                            <div class="mb-3">
                                ...
                                <p class="text-dark">${data.question}</p>
                            </div>
                            <div class="mb-0">
                                <strong>Answer:</strong> 
                                <p class="text-dark">${data.answer}</p>
                            </div>`;
                } else {
