                        ...
                        <div class="row">
                            <div class="col-12">
                                <div id="edit" class="mb-4">
                                    <h2 class="h3 mb-1">Edit Blog</h2>
                                    <p>Update the blog details below and submit.</p>
                                </div>
                                    ...
                                    <div class="tab-content p-4">
                                        <form action="{{ route('blogs.update', $data->id) }}" method="POST"
                                            ...
                                            <div class="form-group mb-4">
                                                ...
                                                <input class="dropify form-control @error('thumbnail') is-invalid @enderror"
                                                    type="file" name="thumbnail" accept="image/*"
                                                    data-default-file="{{ isset($data) && $data->thumbnail ? $data->thumbnail : '' }}">
                                                @error('thumbnail')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="form-group mb-4">
                                                ...
                                                <textarea class="form-control text-dark ps-3 @error('content') is-invalid @enderror" name="content" id="editor"
                                                    placeholder="Enter blog content here" rows="8" required>{{ old('content', $data->content) }}</textarea>
                                                @error('content')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="form-group mb-4">
                                                ...
                                                <select name="status"
                                                    class="form-control text-dark ps-3 h-55 @error('status') is-invalid @enderror">
                                                    <option value="active"
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-12 col-12 d-none d-xl-block position-fixed end-0">
                        <div class="sidebar-nav-fixed">
                            ...
                            <nav class="nav flex-column p-3 bg-light">
                                <a class="nav-link" href="#edit">Edit Blog</a>
                            </nav>
                        </div>
                    </div>
                </div>
