...
@section('title', 'Blogs - SEO Meta Settings')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Blogs SEO Meta Settings</h4>
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('keywords') is-invalid @enderror"
                                                ...
                                                placeholder="Enter keywords separated by comma (e.g. blog, articles, news, tips)"
