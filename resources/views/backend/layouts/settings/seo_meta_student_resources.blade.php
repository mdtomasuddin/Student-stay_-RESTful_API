...
@section('title', 'Student Resources - SEO Meta Settings')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Student Resources SEO Meta Settings</h4>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{ route('seo.meta.update') }}">
                                @csrf
                                @method('PATCH')
                                <input type="hidden" name="page" value="student_resources">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('description') is-invalid @enderror" name="description" id="description"
                                                placeholder="Enter meta description" rows="4" maxlength="500">{{ $seoMeta?->description ?? old('description') }}</textarea>
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('keywords') is-invalid @enderror" name="keywords" id="keywords"
                                                placeholder="Enter keywords separated by comma (e.g. student resources, educational materials, study guides)"
                                                rows="4">{{ $seoMeta?->keywords ? implode(',', $seoMeta->keywords) : old('keywords') }}</textarea>
                                            <small class="text-muted d-block mt-1">Separate multiple keywords with
                                                commas</small>
                                            @error('keywords')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
