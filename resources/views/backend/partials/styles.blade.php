...
.image-uploader .upload-area.drag-over {
    border-color: #3b82f6;
...
.image-uploader .placeholder-content {
    text-align: center;
    pointer-events: none;
    z-index: 1;
}
...
.image-uploader .upload-icon svg {
    width: 28px;
    height: 28px;
    stroke: white;
    stroke-width: 2.5;
...
.image-uploader .placeholder-subtext {
    color: #9ca3af;
    font-size: 13px;
}
...
.image-uploader .remove-btn:hover {
    background: rgba(220, 38, 38, 1);
    transform: scale(1.1) rotate(90deg);
    box-shadow: 0 6px 16px rgba(239, 68, 68, 0.5);
}

.image-uploader .remove-btn:active {
    transform: scale(0.95) rotate(90deg);
}

.image-uploader .file-info {
    display: none;
    position: absolute;
    bottom: 12px;
    left: 12px;
...
.image-uploader .upload-area.has-image {
    border-color: #10b981;
    border-style: solid;
}
</style>
...
<style>
    textarea.form-control.is-invalid {
        background-position: right 1.75rem top 5px !important;
    }
</style>
