    ...
    public function run(): void
    {
        $data = [
            ...
            [
                ...
                "properties_available" => "85",
                "university_name"      => "University of Sussex, University of Brighton",
            ...
            [
                ...
                "properties_available" => "450",
                "university_name"      => "Imperial College, UCL, King's College London",
                "location"             => "London, UK",
            ],
            [
                "name"                 => "Manchester",
                ...
                "properties_available" => "210",
                "university_name"      => "University of Manchester, Manchester Metropolitan",
            ...
            [
                ...
                "university_name"      => "University of Birmingham, Aston University",
            ...
            [
                ...
                "properties_available" => "92",
                "university_name"      => "University of Bristol, UWE Bristol",
                "location"             => "Bristol, UK",
            ],
        ];
